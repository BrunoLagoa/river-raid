...
| **02** | **Batalhas de Chefe & Sistema Overdrive** | Batalhas com chefes navais/aéreos em fases e mecânica de medidor de especial (Overdrive: Laser / EMP). | ⏳ **A Iniciar** | [sprint-2-boss-encounters-and-overdrive.md](file:///Users/bruno/Dev/pocs/river-raid/docs/sprint-2-boss-encounters-and-overdrive.md) |
| **03** | **Perigos Ambientais & Obstáculos** | Minas aquáticas flutuantes com reação em cadeia, redemoinhos no rio e casamatas/torres antiaéreas nas margens. | ⏳ **Pendente** | [sprint-3-hazards-and-obstacles.md](file:///Users/bruno/Dev/pocs/river-raid/docs/sprint-3-hazards-and-obstacles.md) |
