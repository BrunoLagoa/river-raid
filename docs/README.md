...
| **05** | **Controles Customizados, Haptics & Mobile Joystick** | Remapeamento de teclas, feedback tátil (gamepad/mobile) e floating touch joystick analógico. | ⏳ **A Iniciar** | [sprint-5-controls-and-haptics.md](file:///Users/bruno/Dev/pocs/river-raid/docs/sprint-5-controls-and-haptics.md) |
